...
public class SchemeDb {
    ...
    public final static class BirthCertificateTable {
        public static final String NAME = "cerfitificate";

        public final static class Cols {
            public static final String UUID = "uuid_birth_certificate";
    ...
    public static final class RecordTable {
        ...
        public static final class Cols {
            ...
            public static final String ID_CERTIFICATE = "id_birth_certificate";
